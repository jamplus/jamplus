...
rule	: _LBRACE_t block _RBRACE_t
	...
	| ACTIONS_t eflags ARG bindlist _LBRACE_t
	  ...
	  STRING
		{ yymode( SCAN_NORMAL ); }
	  _RBRACE_t
		{ $$.parse = psete( $3.string,$4.parse,$7.string,$2.number,$2.number2,$2.number3 ); }
	;
...
eflags	: /* empty */
		{ $$.number = $$.number2 = $$.number3 = 0; }
	| eflags eflag
		{ $$.number = $1.number | $2.number; if ($2.number2 != 0) $$.number2 = $2.number2; if ($2.number3 != 0) $$.number3 = $2.number3; }
	;
...
eflag	: UPDATED_t
	...
	| MAXLINE_t ARG
		{ $$.number = RULE_MAXLINE;  $$.number2 = atoi( $2.string ); }
	| RESPONSE_t
		{ $$.number = RULE_RESPONSE; }
	| LUA_t
		{ $$.number = RULE_LUA; }
	| MAXTARGETS_t ARG

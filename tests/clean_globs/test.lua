function Test()
    ...
    }, RunJam{'TEST_CLEAN_KEEP_GLOBS=1'})
    ...
    TestPattern({
        ...
        'Removing subdira/subdirb/subdirc/subdird/junk.txt...',
        'Removing subdir1/junk.txt...',
    }, RunJam{'TEST_CLEAN_KEEP_GLOBS=2'})
    ...
    TestPattern({
        ...
        '*** updated 1 target(s)...',
        'Removing subdir1/junk.txt...',
    }, RunJam{'TEST_CLEAN_KEEP_GLOBS=3'})
    ...
    TestPattern({
        ...
        'Removing subdira/subdirb/subdirc/subdird/anotherjunk.txt...',
        'Removing subdira/subdirb/subdirc/subdird/junk.txt...',
    }, RunJam{'TEST_CLEAN_KEEP_TARGETS=1'})

function Test()
	...
	local run1pattern =
	{
		...
		'		1 file(s) copied.',
		'@ CopyFile1 destination/file2.txt',
		'		1 file(s) copied.',
		'@ CopyFile1 destination/dira/file3.dat',
		'		1 file(s) copied.',
		'@ CopyFile1 destination/dirb/abc.txt',
		'		1 file(s) copied.',
		'@ CopyFile1 destination/dirb/copyme/copyme.txt',
		'		1 file(s) copied.',
		'@ CopyFile1 destination/dirb/ignore/dontcopy.txt',
		'		1 file(s) copied.',
		'*** updated 11 target(s)...',
	}
